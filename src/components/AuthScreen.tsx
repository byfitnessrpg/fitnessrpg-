...
import { Shield, Mail, Lock, Flame, Sparkles } from 'lucide-react';
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        onShowModal('Cadastro realizado com sucesso! Faça login para começar a sua jornada no Fitness RPG.');
      }
    } catch (err: any) {
      setErrorMsg(err.message || 'Erro inesperado.');
    } finally {
